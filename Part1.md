...
## Keyboard input
Keyboard input is pretty simple. It follows the JavaFX event handling model: a class which is a designated `EventHandler` receives an `Event` and processes it.
